...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='AserGehad@934',db='cv')
...
st.set_page_config(
   page_title="Baseet Resume Analyzer",
...
st.markdown(
    ...
    <style>
    @keyframes slideshow {
        0%   { background-image: url('https://source.unsplash.com/1600x900/?resume'); }
        25%  { background-image: url('https://source.unsplash.com/1600x900/?career'); }
        50%  { background-image: url('https://source.unsplash.com/1600x900/?coding'); }
        75%  { background-image: url('https://source.unsplash.com/1600x900/?success'); }
        100% { background-image: url('https://source.unsplash.com/1600x900/?resume'); }
    }
...
def run():
    ...
    # st.image(img)
    st.sidebar.markdown("# Choose Something from this drop down:")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built with 🤍 by <a href="Group 10" style="text-decoration: none; color: #021659;">Ahmed Gawad & Gehad Fouad</a></b>' 
    st.sidebar.markdown(link, unsafe_allow_html=True)
    st.sidebar.markdown("Welcome to BASEET Resume Analyzer!")
    ...
    <div>
        <h1 style="margin: 0; font-size: 36px;">Welcome to RESUM</h1>
    </div>
    </div>
    """
    ...
    if choice == 'User':
        ...
        with col1:
            act_name = st.text_input('Name*', key="name_input")

        with col2:
            act_mail = st.text_input('Mail*', key="email_input")

        with col3:
            act_mob = st.text_input('Mobile Number*', key="mobile_input")
        ...
        if location and location.raw:
            address = location.raw.get('address', 'Unknown')
        ...
        pdf_file = st.file_uploader("Choose your Resume", type=["pdf"], key="resume_upload")
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                if 'Objective' or 'Summary' or 'A B O U T M E' in resume_text:
                    resume_score = resume_score+6
                    st.markdown('''<h5 style='text-align: left; color: #1ed760;'>[+] Awesome! You have added Objective/Summary</h4>''',unsafe_allow_html=True)                
                else:
                    st.markdown('''<h5 style='text-align: left; color: #000000;'>[-] Please add your career objective, it will give your career intension to the Recruiters.</h4>''',unsafe_allow_html=True)

                if 'Education' or 'School' or 'College' or 'E D U C A T I O N' or 'Degree'in resume_text:
                ...
                if 'EXPERIENCE' or 'E X P E R I E N C E' in resume_text:
                ...
                if 'INTERNSHIPS' or 'V O L U N T E E R I N G'  in resume_text:
                    resume_score = resume_score + 6
                ...
                if 'SKILLS' or 'S K I L L S'  in resume_text:
                ...
                if 'CERTIFICATIONS' or 'C O U R S E S' in resume_text:
                    resume_score = resume_score + 12
                ...
                if 'PROJECTS' or 'products' in resume_text:
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        Built with 🤍 by <strong>Ahmed Gawad</strong> && <strong>Gehad Fouad</strong>
        </p>
